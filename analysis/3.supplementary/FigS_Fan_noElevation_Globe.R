...
x_bound <- round(max(abs(shap_long_forest$value)))+1
...
x_bound <- round(max(abs(shap_long_dry$value)))+1
...
x_bound <- round(max(abs(shap_long_crop$value)))+1
...
png(filename = paste0("/Users/jiangongliu/Desktop/5_WTD_Aridity/figure/", 
                      "FigS_global_importance_noEle.png"), 
