# Plot beeswarm plots for the moisture index, elevation and water table depth (dataset from GLOBGM)
...
model_training_folder <- 'data/model_output/model_training_elevation_US_globgm'
