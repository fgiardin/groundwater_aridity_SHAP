This directory contains the output of the analysis:
...
* **model_training_elevation_US_Fan_oneModel**: Contains model outputs and Causal Shapley values derived from running the model collectively for all vegetation groups across the CONUS, using WTD data from Fan et al. (to generate Fig. 4)
